...
We employed a 4-stage iterative modeling approach to benchmark algorithmic performance:
...
**Primary Metrics:** Evaluation was based on **ROC-AUC (0.5–1.0)** for overall separation and **Recall** to prioritize catching the minority "vaccinated" class.
